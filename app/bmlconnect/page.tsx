          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-border bg-foreground/5 p-5">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className={`rounded-xl border-2 p-4 transition-all ${storageLocation === "drive" ? "border-primary bg-primary/5" : "cursor-pointer border-border bg-background hover:border-primary/50"}`}
                  onClick={() => initiateStorageSwitch("drive", "Google Drive")}
                >
        ...
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-3xl bg-panel border border-border p-8">
            ...
            <div className="mb-6 p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-xs text-amber-500 leading-relaxed">
              ...
              Provide your Torn API key to connect Google Drive.
            </div>
